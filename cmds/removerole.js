...
module.exports.run = async (bot, message, args) => {
  ...
  try{
    await rMember.send(`Rest in peace, you lost the ${gRole.name} role.`)
  }catch(e){
    message.channel.send(`Rest in peace <@${rMember.id}>, We removed ${gRole.name} from them. We tried to DM them, but their DMs are locked.`)
  }
}
